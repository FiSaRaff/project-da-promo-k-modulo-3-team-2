list_column_dot=["monthlyincome", "monthlyrate", "performancerating", "totalworkingyears", "worklifebalance", "sameasmonthlyincome", "salary"]

diccionario_remote = {"1": "Yes", "0": "No", "Yes": "Yes", "True": "Yes", "False": "No"}

dict_gender = {0: "M", 1: "F"}

list_column_lower=["department", "educationfield", "jobrole", "roledepartament"]

list_round = ["dailyrate", "hourlyrate", "dailyrate", "monthlyrate", "monthlyincome", "salary"]

dict_department = {'healthcare representative': 'research & development',
